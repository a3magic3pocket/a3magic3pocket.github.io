...
- 실행방법
    ...
    - gh-page branch를 선택하고 Save를 눌러 저장한다.  
      <a href="/assets/img/2020-10-23-chirpy-safe-deployment/01-save-settings.jpg" target="_blank"><img src="/assets/img/2020-10-23-chirpy-safe-deployment/01-save-settings.jpg" width="80%" height="80%">  
